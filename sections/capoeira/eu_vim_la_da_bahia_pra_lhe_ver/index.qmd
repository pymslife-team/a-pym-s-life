...
categories:
  - capoeira
  - chant
title-block-banner: pelorinho_large.jpg
image: eu_vim_la_da_bahia_cover.png
image-alt: Les rue de Salvador à Bahia
---
...
- Dans la phrase « __Eu vim la da Bahia pra lhe ver__ », l'enchainement "la da Bahia" est prononcé comme un seul mot "ladabahia"
...
leaflet() %>%
  ...
  addMarkers(lng=-38.509677, lat=-12.973307, popup="Le Pelorinho, cœur historique de Salvador") %>%
  addMarkers(lng=-38.6313115, lat=-12.8640287, popup="La Baie de Tous les Saints ou s'abritaient les navires et qui rendit la ville de Salvador si attractive pendant des siècles") %>%
  addMarkers(lng=-38.6813297, lat=-13.0055737, popup="L'Île d'Itaparica, de l'autre côté de la Baie")
```
