...
description: Tel le Docteur PYM (je vous jure cette homonimie est fortuite !) enfonçons-nous toujours plus loin dans le monde quantique, jusqu'à voir quels effet il a sur le monde classique
date: 2022-05-08
...
categories:
  ...
  - chimie
  - tableau périodique
title-block-banner: messy-room.jpg
image: messy-room.jpg
image-alt: Électron, va falloir ranger ta chambre fissa !
series: C'est quoi les nombres quantiques
---

Après un [premier](/sections/sciences/atomes-nombres-quantiques-et-toutes-ces-conneries/index.qmd) puis un [second épisode](/sections/sciences/atomes-nombres-quantiques-et-toutes-ces-conneries-2/index.qmd), reprise(de tête) du petit cours d'intro à la physique quantique pour comprendre la chimie !
...
Alors les chimistes ont une technique assez simple pour ranger les électrons façon feng shui : on les range de la plus basse énergie à la plus haute… en gros, on remplit en premier là où ça coute le moins cher !

Euh, mais alors, c'est facile ! On remplit dans l'ordre `1s 2s 2p 3s 3p 3d 4s` etc. !!!

Nan. Car, en fait, les énergies des différentes sous-couches des fois il empiète un peu sur le niveau d'au-dessus et ça fout un peu le bordel.

![Voilà ce qui se passe quand tu laisses un crayon à un chimiste, il dessine des niveaux d'énergie !](niveaux_d_energie.jpg)

Les chimistes, ils ont fait un joli schéma vu qu'ils ont passé 50 ans à mesure toutes leurs fucking raies dans tous les sens ! On y voit par exemple que si on veut aller par énergie croissante au début ça marche bien : `1s 2s 2p 3s 3p`… et là, c'est le drame 😱 `4s` avant `3d` 😱😱😱

Bon, avec le graph des énergies sous le nez on arrive à remplir les niveaux dans l'ordre, mais c'est un peu casse-~~couilles~~ gonades. L'autre solution c'est de se taper les calculs exacts du niveau d'énergie à chaque fois… bon OK, ce n’est VRAIMENT pas plus simple !
...
Il avait fallu des années pour le faire expérimentalement… des années… et il y a toujours eu plein de trous dedans (car on n’avait pas découvert l'élément à tel ou tel endroit) et pour le faire il avait fallu regarder comment chaque élément réagissait avec plein de trucs pour le mettre dans la bonne colonne (dans une colonne, tous les éléments doivent réagir pareil).
...
Donc la physique quantique avec ses électrons gazeux qui se téléportent, qui se comportent comme des fantômes et qui tels des instagrameuses posent pour la photo dès qu'on les regarde et ses atomes entourés de grosses bouboules, altères et autres morceaux de ballon venu des enfers… eh ben c'est la meilleure description qu'on ait de la réalité (pour les machins très petits) !

# À retenir

- le principe de décrire les électrons avec 4 nombres quantiques qui ont des valeurs ultras limitées : **n ℓ mℓ** et **s**
...
- Aucune idée d'où j'ai récupéré la photo de la chambre d'ado… si quelqu’un veut contribuer et m'envoyer une belle photo de chambre bordélique en Creative Common je suis preneur !
- Les images des tableaux périodique sont issue de la [page wikipedia "tableau périodique"](https://fr.wikipedia.org/wiki/Tableau_p%C3%A9riodique_des_%C3%A9l%C3%A9ments) et sont sous [licence CC BY-SA](https://creativecommons.org/licenses/by-sa/3.0/deed.fr)
