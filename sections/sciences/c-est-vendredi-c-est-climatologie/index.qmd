...
description: Expliquons les bases du climat à une élève de seconde
date: 2021-08-20
...
categories:
  ...
  - geographie
  - climat
title-block-banner: globe_en_main.jpg
image: extrem_climate_logo.webp
image-alt: Le climat en ce moment c'est pas ton ami (et pas qu'en histoire-géo)
...
Voilà ce qu'on m'a posé comme question et bon bah comme d'hab' je vais essayer d'y répon… quoi ?! On ne me l'a pas vraiment demandé ? Bon OK, techniquement ce qu'on m'a dit c'est « _Le programme de géo au collège c'est chiant_ », il est possible qu'après j'aie surinterprété la requête de mon interlocutrice…
...
![Oui, je sais, je réveille des traumas chez plein de gens…](drunk-alcohol.gif)
...
![Météorologue bien connu : Winnie](pooh-think.gif)
...
| — …
| — Nan, ça ne serait pas plus simple. En physique, on aime bien les trucs ronds… ça a tout plein de symétries qui facilitent tous les calculs… et ça permet de se la péter avec des sinus et des cosinus partout ! [#trigoÉlitisme](https://short-edition.com/fr/oeuvre/poetik/trigonometrie-damour-1){.hashtag} »
:::
...
![Rhoooo ça va hein, c'est pour les lycéens ! (vous pourriez me dire "justement")](not-fair.gif)
...
![Les rayons solaires ça tape un peu à plat sur les bords !](inclinaison-des-rayons-solaires.png){width="60%"}
...
![…ah un peu de contradiction, c'est bien ça la contradiction ! Oui, mon bon Donald, que veux-tu ?](no-stop-donald.gif)
...
{{< video https://www.youtube.com/embed/KYic1U1a6yw start="58" >}}
...
![Ariel, arrête de faire la conne…](blow-blowing.gif)
...
![Si tu enfermes ton air chaud dans un gros drap, tu obtiens un ballon à air chaud c.-à-d. une montgolfière](hot-balloons.gif)
...
![Ah nan pas elle… je vais encore avoir une chanson dans la tête[^toolate]](frozen-disney.gif)

![C'est mieux... mais con de vent quand même…](against-the-wind.gif)
...
![Une cellule polaire[^goulag]](Atmospheric_circulation-fr-zoom_polaire.svg)

:::

[^goulag]: Rien à voir avec le [goulag](https://fr.wikipedia.org/wiki/Goulag)

On a aussi une "cellule" 🔁 de chaque côté de l'équateur (une _Cellule de Hadley_) :
...
![Une cellule ~~équatoriale~~ de Hadley (oui il faut tourner la tête vers la droite)](Atmospheric_circulation-fr-zoom_equateur.svg)
...
![Voilà nos 3 cellules qui s'emboitent bien comme des engrenages](Atmospheric_circulation-fr.svg)
...
{{< https://www.youtube.com/embed/ScXxy0MI2WQ start="20" aspect-ratio="4x3" >}}
...
![Vous voyez bien, quand on était gamin on kifait les référentiels en rotation uniforme ! Et vous avez vu comment je portais bien la robe de princesse ?](spinning-girls.gif)
...
![Oh les vents sont tous orientés comme il faut !!! Et je vois même les zones où il y a des **anticyclones** (A) et des **dépressions** (D)](Atmospheric_circulation-fr.svg)
...
[^kyudo]: Les archers japonais qui pratiquaient le Kyudo (art martial du tir à l'arc) pouvaient toucher une cible à plus de 800 m, voir plus… là aussi il devait compenser la force de Coriolis… généralement sans avoir la moindre idée de son existence !!! Costauds les loulous !
[^punk]: Au palais de la Découverte, le manège tourne assez vite pour que tout soit affecté… donc si vous vous déplacez pour aller vous assoir au siège d'en face (ce qui est interdit) vous allez tituber comme jamais. Je le sais je l'ai fait [#punkNotDead](https://crowdagger.fr/punk-is-undead/){.hashtag}
[^continental]: Il est vrai que Berlin et Nantes ce n’est pas vraiment le même climat…
...
Bon, donc, on vient de trouver pourquoi on a de la glace aux pôles. Mais ce n’est pas vraiment ce qu'on cherchait.[^polemethane]
...
Méditerranéen
  ~ Climat important historiquement, mais c'est en gros de l'océanique un peu sec, car son océan est petit (on peut le retrouver ailleurs qu'en méditerranée s’il y a de bons facteurs pour modérer un océanique classique)[^mediterranee]
...
- [Photo du globe terrestre entre des mains](https://unsplash.com/fr/photos/1TjORT2dLOw) par [Greg Rosenke](https://unsplash.com/fr/@greg_rosenke) et sous [licence Unsplash](https://unsplash.com/fr/licence)
- Logo extreme [climate logo](https://sitn.hms.harvard.edu/seminars/2013/extreme-weather-causes-effects-and-connections-with-climate/) by [SITNBoston](https://sitn.hms.harvard.edu/) for the 2013 seminar "Extreme Weather: Causes, Effects, and Connections With Climate" sous [licence CC BY-NC-SA](http://creativecommons.org/licenses/by-nc-sa/4.0/)
- [Schéma de l'inclinaison des rayons solaires](inclinaison-des-rayons-solaires.png) par PYM (votre serviteur) sous [licence CC BY-NC-SA](http://creativecommons.org/licenses/by-nc-sa/4.0/)
- [Schéma de la circulation atmosphérique](https://fr.wikipedia.org/wiki/Fichier:Atmospheric_circulation-fr.svg) par [Pinpin](https://commons.wikimedia.org/wiki/User:Pinpin) pour wikipedia sous [licence CC BY-SA](https://creativecommons.org/licenses/by-sa/3.0/deed.fr)
