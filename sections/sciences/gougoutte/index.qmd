...
description: Calculons beaucoup trop précisément le danger de lancer une goutte d'eau dans l'océan
date: 2021-01-05
...
categories:
  ...
  - physique
  - boom
title-block-banner: Planetoid_crashing_into_primordial_Earth.jpg
image: Planetoid_crashing_into_primordial_Earth.jpg
image-alt: Artist's impression of a 1000km-diameter planetoid hitting a young Earth
---
...
C’est alors que quelqu’un[^phil] a fait la remarque, pas con du tout, que « *ça dépend de la vitesse de la goutte d’eau, disons qu’une goutte d’eau d’une taille de 2 mm sur 4 tomber à une vitesse proche de celle de la lumière, ça pourrait même créer un tsunami, et peut-être même traverser une partie de la couche terrestre sous-marine* »

[^phil]: Phil pour ceux qui veulent tout savoir…

## Someone was wrong…

![L'histoire de 99% de ma vie](duty_calls.png){width="60%"}

[#someoneiswrongotheinternet](https://youtu.be/oK2fsx9Z9sM){.hashtag} et j’ai voulu expliquer pourquoi… accrochez-vous au pinceau, j’enlève l’échelle. Et je vous préviens hier j’étais très, très, très en forme. Suzanne F. tu te souviens de mes posts vaccin ou éducation, ben là je crois que comme c’était vraiment mon domaine je suis parti en freefly (avec une fritte, mais c’est les sponsors qui m’ont forcé…).
...
![Fermez la fenêtre, ya des courants d'air](ya_du_vent.gif)
...
Donc notre goutte d’eau la plus rapide du monde ça serait une goutte d’eau qui va à 8 658 km/h pendant quelques millisecondes. Loin très loin de la vitesse de la lumière (dans le vide vu que dans un cristal bien fichu [on peut la baisser à quelques cm/s](https://en.wikipedia.org/wiki/Slow_light)).
...
![The gougoutte](goutte_manga.gif)

## Changer les courants avec ça ?

On a donc une mega gougoutte de la mort... mais est-ce qu'on peut changer les courants
marins avec ? Prenons le [Gulf Stream](https://fr.wikipedia.org/wiki/Gulf_Stream) par
exemple qui passe dans l'Atlantique Nord. Il transporte en moyenne 20 millions de m³
...
:::{.big-centered}
[To be continued…](/sections/sciences/gougoutte/index.qmd)
:::

[Bon bah, la suite c'est là !](/sections/sciences/gougoutte-with-a-vengeance/gougoutte-2.html)

#### Crédits photo {.appendix}

- [Vue d'artiste d'une chute de planétoïde](https://en.wikipedia.org/wiki/Don_Davis_(artist)#/media/File:Planetoid_crashing_into_primordial_Earth.jpg) par [Ronald E. Davis](https://en.wikipedia.org/wiki/Don_Davis_(artist)) placé dans le domaine public dans le cadre de son travail pour la NASA
- Dessin [Someone was wrong on the internet](https://xkcd.com/386/) de [Randall Munroe](https://fr.wikipedia.org/wiki/Randall_Munroe) sous [licence CC BY-NC 2.5](http://creativecommons.org/licenses/by-nc/2.5/)
